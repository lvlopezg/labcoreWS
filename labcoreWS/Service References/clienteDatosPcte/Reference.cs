...
namespace labcoreWS.clienteDatosPcte {
    ...
    public interface IdatosPaciente {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IdatosPaciente/datosXatencionXFactura", ReplyAction="http://tempuri.org/IdatosPaciente/datosXatencionXFacturaResponse")]
        labcoreWS.clienteDatosPcte.pacienteS1 datosXatencionXFactura(int nroAtencion, int nroFactura);
    }
    ...
    public partial class IdatosPacienteClient : System.ServiceModel.ClientBase<labcoreWS.clienteDatosPcte.IdatosPaciente>, labcoreWS.clienteDatosPcte.IdatosPaciente {
        ...
        public labcoreWS.clienteDatosPcte.pacienteS1 datosXatencionXFactura(int nroAtencion, int nroFactura) {
            return base.Channel.datosXatencionXFactura(nroAtencion, nroFactura);
        }
    }
}
